...
Select JDK 24, select your OS, and downlaod the suitable file to install java 24.
Program should work after this. Contact keleshod@tcd.ie if it does not.

# How to run the program on a Linux machine
Run the run.sh file! However, make it executable first (please) -> chmod +x run.sh
You must have the java 24 installed.
Download it [here](https://www.oracle.com/ie/java/technologies/downloads/).
